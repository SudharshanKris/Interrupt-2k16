...
<html>
    <head>
        <meta charset="utf-8">
        <title>Code Sprint &middot; Interrupt '16</title>
                    ...
                    <div class="col-lg-12">
                        <div class="well bs-component">
                            <p style="font-size: 25px;">What's it? </p>
                               <p style="font-size: 25px;">Interrupt 2k16 has an Epic Online Coding Competetion starting off with a light MCQ questions. Answer questions as much as possible and quickly too. Participate - Complete - Go offline with Gifts</p>
                            <br>
                               <p class="text-left" style="font-size: 25px;">
                                   <b>Plot:</b><br>

 Each level consists of 15 questions.<br>
	1)The contest has two rounds.<br><br>
                                   <b>Round 1:</b><br>

This has a variety of questions .This round will clam you down before you enter some serious<br>

coding.question in this round are connections,Jumbled program,debugging and output prediction.<br>

Relax! All questions are multiple choice questions with no negative marks.<br>

 The Perk : You can go to the next question without answering the previous question.!!.<br>
                                   <br>
                                   <b>Round 2:</b><br>
a)This round has 5 questions.<br>

b)You can use c/c++ to write programs.<br>

c)Input must be obtained from standard input(scanf or cin) and output must be redirected to

standard output(printf or cout).<br>

d)the output must be in the format specified in the sample output<br>

e)One question must be completed to view the next one.<br>

</p>
                               <br>
                            <legend style="font-size: 25px;"><b>Rules:</b></legend>
