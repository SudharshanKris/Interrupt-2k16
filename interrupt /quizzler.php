...
<html>
    <head>
        <meta charset="utf-8">
        <title>Quizzler &middot; Interrupt '16</title>
    ...
    <body>
        <div class="container">
        	...
        	<div class="wow delay-04s animated slideInUp "data-wow-delay="1200ms">
				<a href="index.php" style="text-decoration:none !important;"><h2 id="keek" class="text-center" style="text-transform: uppercase !important; text-decoration:none !important; font-size: 60px;  color:#009688; font-weight: 400;">Interrupt '16</h2></a>
			</div>
            <div class="text-center">
                <a href="index.php" class="btn btn-success" style=" background-color: #009688;"><i class="fa fa-home fa-5x" style="font-size: 2.3rem;" aria-hidden="true"></i> </a>
            </div>
        </div>      
        <hr>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="well bs-component">
                            <p style="font-size: 25px;">What's it? </p>
                               <p style="font-size: 25px;">Interrupt 2k16 has a new mash up of fun games called the Quizzler. Quizzler is a combo of connections, LogoQuiz and Start-Up quiz. Answer questions as much as possible and quickly too. Participate - Complete - Go offline with Gifts</p>
                               <p style="font-size: 25px;" class="text-left"><b>PLOT:</b><br>

                                   The quintessential geek is defined by the thick, round glasses and frequent usage of big technical words like “Architectural Neutral Distribution Format “. Sounds familiar?<br>
                                   Are you willing to fight it out in a buzzer induced frenzy? Are you ready to be questioned on anything under the sun? (Or cloud, pun intended).As the clock keeps ticking, we expect you to bring your A game at Interrupt this year!<br>
                                   <br>
                                   <b>Event Structure</b>
                                   <br>
                                   The event is organised into 3 levels: Easy, Medium and Hard.<br>
                                   Level 1 consists of 80 questions followed by 60 questions in level 2 and 30 questions in level 3.<br>
                                   The questions are randomly generated at each level according to their level of difficulty.<br><br>
                                   Each level consists of questions that fall under six major categories, namely:<br>
                                   - Connections<br>
                                   - 4pics 1 word<br>
                                   - Scramble<br>
                                   - Label writing<br>
                               ...
                               <br><br>
                            <legend style="font-size: 25px;" class="text-left"><b>Rules</b></legend>
                            <ul style="font-size: 25px;" class="text-left">
                                <li>The decision of the judges will be final.</li>
                                <li>Only college students may participate. </li>
                                <li>The winner must be present at the venue on the day of symposium to collect the prize if not the prize will be given to the next position. Prizes will NOT be couriered or transferred.</li>
                                ...
                                <li>you can open a new question only if you answer the current question correctly.</li>
                            </ul>
                            <br>
